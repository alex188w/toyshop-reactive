...
public class CartController {
         ...
         * <li>Вызывает {@link PaymentServiceClient#getBalance()} для получения баланса
         * пользователя.</li>
         ...
         * @return реактивный объект {@link Mono}, содержащий карту с данными для оплаты
         */
         ...
         *                  управление cookie)
         * @param model     модель для передачи данных на страницу
         * @return результат обработки: {@code redirect:/orders/{id}} или {@code cart} с
         *         ошибкой
         */
        ...
        public Mono<String> confirmPayment(
                ...
                return cartService.getCartView(sessionId)
                                .flatMap(cartView -> handleCartCheckout(sessionId, cartView, exchange, model));
        }
